...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        public abstract class Part : Entry
        {
            ...
            /// <summary>
            /// Set all display groups to zero.
            /// </summary>
            public void ClearDispGroups()
            {
            ...
            public class Object : Part
            {
                ...
                /// <summary>
                /// Pose of object skeleton.
                /// </summary>
                public short ObjectPose { get; set; }
            ...
            public class Enemy : Part
            {
                ...
                /// <summary>
                /// Default standby animation to loop.
                /// </summary>
                public int DefaultStandbyAnimation { get; set; }
                ...
                internal Enemy(BinaryReaderEx br) : base(br)
                {
                    ...
                    DefaultStandbyAnimation = br.ReadInt32();
                    UnkT3C = br.ReadInt32();
                }
