...
class State_6(State):
    ...
    def previous_states(self):
        return [State_2, State_4, State_5, State_11, State_15, State_17, State_23, State_24, State_30, State_32, State_34, State_36]
    ...
    def test(self):
        if CheckSelfDeath() == 1 and GetFlagState(1548) == 0 and GetDistanceToPlayer() <= 5:
            return State_15
        if GetFlagState(1547) == 1 and IsPlayerDead() == 1 and GetDistanceToPlayer() <= 5 and GetFlagState(71700042) == 0 and HasDisableTalkPeriodElapsed() == 1 and IsTalkingToSomeoneElse() == 0 and CheckSelfDeath() == 0 and IsCharacterDisabled() == 0 and IsClientPlayer() == 0 and GetRelativeAngleBetweenPlayerAndSelf() <= 180 and GetDistanceToPlayer() <= 5:
            return State_34
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and GetFlagState(1542) == 1 and GetFlagState(71700038) == 0:
            return State_20
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and GetFlagState(71700041) == 1 and GetFlagState(1542) == 1:
            return State_29
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and GetFlagState(71700040) == 1 and GetFlagState(1542) == 1:
            return State_28
        if IsPlayerTalkingToMe() == 1 and GetRelativeAngleBetweenPlayerAndSelf() <= 45 and GetDistanceToPlayer() <= 2 and GetOneLineHelpStatus() == 1 and GetFlagState(71700038) == 1 and GetFlagState(1542) == 1 and GetFlagState(71700040) == 0 and GetFlagState(71700041) == 0:
            return State_14
...
class State_7(State):
    ...
    def test(self):
        if CheckSelfDeath() == 1 and GetDistanceToPlayer() <= 5:
            return State_17
        if IsPlayerAttacking() == 1 and GetDistanceToPlayer() <= 5 and GetFlagState(71700037) == 0 and GetSelfHP() <= 90:
            return State_12
        if GetFlagState(1547) == 1:
            return State_10
        if GetFlagState(71700036) == 0 and IsPlayerAttacking() == 1 and GetDistanceToPlayer() <= 5 and GetFlagState(71700035) == 1:
            return State_21
        if GetFlagState(71700035) == 0 and IsPlayerAttacking() == 1 and GetDistanceToPlayer() <= 5:
            return State_8
        if GetFlagState(71700036) == 1:
            return State_10
        else:
            return State_10
...
class State_8(State):
    ...
    def enter(self):
        TalkToPlayer(conversation=39000230, unk1=-1, unk2=-1)
        SetFlagState(flag=71700035, state=1)
        ForceCloseMenu()
...
class State_12(State):
    ...
    def enter(self):
        TalkToPlayer(conversation=39000300, unk1=-1, unk2=-1)
        SetFlagState(flag=71700037, state=1)
        ForceCloseMenu()
...
class State_14(State):
    ...
    def enter(self):
        DisplayOneLineHelp(text_id=-1)
        TalkToPlayer(conversation=39000100, unk1=-1, unk2=-1)
...
class State_15(State):
    ...
    def enter(self):
        TalkToPlayer(conversation=39000400, unk1=-1, unk2=-1)
        DisplayOneLineHelp(text_id=-1)
        ForceCloseMenu()
...
class State_20(State):
    ...
    def enter(self):
        DisplayOneLineHelp(text_id=-1)
        TalkToPlayer(conversation=39000000, unk1=-1, unk2=-1)
...
class State_21(State):
    ...
    def enter(self):
        TalkToPlayer(conversation=39000240, unk1=-1, unk2=-1)
        SetFlagState(flag=71700036, state=1)
        ForceCloseMenu()
...
class State_25(State):
    ...
    def enter(self):
        ...
        SetFlagState(flag=71700040, state=1)
...
class State_26(State):
    ...
    def enter(self):
        ...
        SetFlagState(flag=71700041, state=1)
...
class State_28(State):
    ...
    def enter(self):
        TalkToPlayer(conversation=39000120, unk1=-1, unk2=-1)
...
class State_29(State):
    ...
    def enter(self):
        TalkToPlayer(conversation=39000140, unk1=-1, unk2=-1)
...
class State_32(State):
    ...
    def enter(self):
        SetFlagState(flag=71700038, state=1)
...
class State_34(State):
    ...
    def enter(self):
        TalkToPlayer(conversation=39000500, unk1=-1, unk2=-1)
        DisplayOneLineHelp(text_id=-1)
        SetFlagState(flag=71700042, state=1)
...
class State_35(State):
    ...
    def enter(self):
        SetFlagState(flag=11700593, state=1)
...
class State_36(State):
    ...
    def enter(self):
        SetFlagState(flag=71700042, state=0)
