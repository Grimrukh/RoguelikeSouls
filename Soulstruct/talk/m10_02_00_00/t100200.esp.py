...
class State_4(State):
    ...
    def enter(self):
        ...
        RequestSave(0)
        AddTalkListData(menu_index=1, menu_text=15000500, required_flag=-1)  # Warrior
        AddTalkListData(menu_index=2, menu_text=15000501, required_flag=-1)  # Knight
        AddTalkListData(menu_index=3, menu_text=15000502, required_flag=-1)  # Wanderer
        AddTalkListData(menu_index=4, menu_text=15000503, required_flag=-1)  # Thief
        AddTalkListData(menu_index=5, menu_text=15000504, required_flag=-1)  # Barbarian
        AddTalkListData(menu_index=6, menu_text=15000505, required_flag=-1)  # Hunter
        AddTalkListData(menu_index=7, menu_text=15000506, required_flag=-1)  # Sorcerer
        AddTalkListData(menu_index=8, menu_text=15000507, required_flag=-1)  # Cleric
        AddTalkListData(menu_index=9, menu_text=15000510, required_flag=-1)  # One life mode
        AddTalkListData(menu_index=10, menu_text=15000130, required_flag=-1)  # Attune magic
        AddTalkListData(menu_index=11, menu_text=15000005, required_flag=-1)  # Leave
...
class State_GetWarrior(State):
    """ 72: Get Warrior equipment."""

    def enter(self):
        SetFlagState(11022400, 1)

    def test(self):
        return State_InterruptTalkMenu


class State_GetKnight(State):
    """ 73: Get Knight equipment."""

    def enter(self):
        SetFlagState(11022401, 1)

    def test(self):
        return State_InterruptTalkMenu


class State_GetWanderer(State):
    """ 74: Get Wanderer equipment."""

    def enter(self):
        SetFlagState(11022402, 1)

    def test(self):
        return State_InterruptTalkMenu


class State_GetThief(State):
    """ 75: Get Thief equipment."""

    def enter(self):
        SetFlagState(11022403, 1)

    def test(self):
        return State_InterruptTalkMenu


class State_GetBarbarian(State):
    """ 76: Get Barbarian equipment."""

    def enter(self):
        SetFlagState(11022404, 1)

    def test(self):
        return State_InterruptTalkMenu


class State_GetHunter(State):
    """ 77: Get Hunter equipment."""

    def enter(self):
        SetFlagState(11022405, 1)

    def test(self):
        return State_InterruptTalkMenu


class State_GetSorcerer(State):
    """ 78: Get Sorcerer equipment."""

    def enter(self):
        SetFlagState(11022406, 1)

    def test(self):
        return State_InterruptTalkMenu


class State_GetCleric(State):
    """ 79: Get Cleric equipment."""

    def enter(self):
        SetFlagState(11022407, 1)

    def test(self):
        return State_InterruptTalkMenu


class State_ActivateOneLife(State):
    """ 80: Go to one life and get gift."""

    def enter(self):
        SetFlagState(11022410, 1)
