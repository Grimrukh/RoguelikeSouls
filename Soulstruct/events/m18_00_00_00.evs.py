...
def ActivateExitBonfire():
    ...
    Await(not Flags.Exit2Disabled and DialogPromptActivated(CommonTexts.ReturnToFirelink, Objects.Exit2Prompt,
                                                            max_distance=2.0))
...
def InvaderTrigger(_, invader: Character, spawn_point: Region, trigger: Region,
    ...
    """ 11805200: Invasion is triggered. Human not needed. """
    DisableNetworkSync()
...
def InvaderKilled(_, invader: Character, dead_flag: Flag):
    """ 11802260: Invader in this map has been killed. Also disables them on startup. """
